...
#define INVALID_NAME "Invalid name. Input another name. "
#define NOT_YOUR_TURN "It is not your turn to guess.\n"
#define START_PLAY "Press enter to start playing."
#define ANNOUNCE_TURN "Your guess?\n"
